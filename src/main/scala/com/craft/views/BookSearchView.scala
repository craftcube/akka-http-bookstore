package com.craft.views

import com.craft.models.{Book, Category}
...
object BookSearchView {
  ...
  def view(categories: Seq[Category], currencies: Seq[String],
           books: Seq[Book],
           errors: List[String] = List(),
           currentCurrency: String = CurrencyService.baseCurrency) = html(
    head(
