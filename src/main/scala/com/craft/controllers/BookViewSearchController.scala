...
import com.craft.models.{Book, BookSearch, BookSearchJson}
import com.craft.repositories.{BookRepository, CategoryRepository}
import com.craft.services.CurrencyService
import com.craft.views.BookSearchView

import scala.concurrent.{ExecutionContext, Future}
import scala.util.{Failure, Success, Try}


class BookViewSearchController(val categoryRepository: CategoryRepository, val bookRepository: BookRepository)
                              (implicit val ec: ExecutionContext, as: ActorSystem, mat: Materializer)
  extends BookSearchJson {
